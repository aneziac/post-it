...
#show: poster.with(
  ...
  university-logo: image("assets/whitelogo.png", height: 100%),
...
#pad(
  grid(
    ...
    grid(
      rows: 2,
      row-gutter: rgutter,
      poster_section("Coxeter Systems", coxeter_systems, base-colors),
      poster_section("Chambers and Nerves", chambers_and_nerves, base-colors, fill: true)
    ),
    grid(
      rows: 2,
      row-gutter: rgutter,
      poster_section("The Davis Complex as a Basic Construction", basic_construction, base-colors, fill: true),
      poster_section([The Davis Complex is _CAT(0)_], Davis_complex_CAT0, base-colors)
    ),
    grid(
      rows: 4,
      row-gutter: rgutter,
      poster_section("Tits Representation", tits_representation, base-colors),
      poster_section("Buildings", buildings, base-colors, fill: true),
      poster_section("Acknowledgements", acknowledgements, base-colors),
